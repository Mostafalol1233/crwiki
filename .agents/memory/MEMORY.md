...
- [Admin source editor](admin-source-editor.md) — Rich content uses visual TipTap mode plus a complete HTML Source mode; preserve presentation markup but never execute imported scripts.
