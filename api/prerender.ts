...
async function resolveMeta(path: string): Promise<PageMeta> {
  ...
  const sectionMeta: Record<string, Partial<PageMeta>> = {
    ...
    "/editorial-policy": { title: "Editorial Policy — CrossFire Wiki", description: "How CrossFire Wiki verifies and publishes CrossFire information. Independent community reference." },
    "/sources":      { title: "Sources — CrossFire Wiki", description: "How CrossFire Wiki sources and verifies CrossFire information. Official announcements, game files and reviewed community documentation." },
  ...
  const sectionMetaAr: Record<string, { title: string; description: string }> = {
    ...
    "/editorial-policy": { title: "سياسة التحرير | CrossFire Wiki", description: "كيف تتحقق CrossFire Wiki من معلومات CrossFire وتنشرها." },
    "/sources": { title: "المصادر | CrossFire Wiki", description: "كيف توثق CrossFire Wiki معلومات CrossFire. الإعلانات الرسمية وملفات اللعبة." },
