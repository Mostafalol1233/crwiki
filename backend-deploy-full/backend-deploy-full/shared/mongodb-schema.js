...
const MapSchema = new Schema({
    name: { type: String, required: true },
    map_slug: { type: String, default: "", index: true },
    imageUrl: { type: String, default: "" },
    imageHistory: [{ url: String, timestamp: { type: Date, default: Date.now } }], // Archive for images
    thumbnailUrl: { type: String, default: "" },
    minimapUrl: { type: String, default: "" },
    description: { type: String, default: "" },
    loreDescription: { type: String, default: "" },
    releaseDate: { type: String, default: "" },
    designer: { type: String, default: "" },
    modeCompatibility: { type: [{ mode: String, available: Boolean, details: Schema.Types.Mixed }], default: [] },
...
export const insertMapSchema = z.object({
    ...
    modeCompatibility: z.array(z.object({
        mode: z.string(),
        available: z.boolean(),
