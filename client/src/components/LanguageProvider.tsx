...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Home page
    exploreTheWiki: "Explore The Wiki",
    ...
    onThisWikiDesc: "CrossFire Wiki is a community resource covering every aspect of the CrossFire FPS game. Explore weapons, maps, ranks, mercenaries and more.",
    didYouKnow: "Did You Know?",
    quickNavigation: "Quick Navigation",
    communityLabel: "Community",
    joinOurDiscord: "Join our Discord",
    activePlayersCount: "Hundreds of active CF players",
    joinNow: "Join Now",
    liveChat: "Live Chat",
    ...
    portalMercenariesDesc: "Elite playable operators",
    ...
    pricingSubheading: "Everything you need — prices, what to spend on, and where to top up safely.",
    ...
    pricingBonus: "bonus",
    pricingSafeTip1: "Only buy from the official Z8Games store or verified community sellers with reviews.",
    ...
    pricingSafeTip4: "If a deal sounds too good to be true, it probably is — stick to trusted sources.",
    pricingSafeTip5: "Check our verified sellers page for community-reviewed providers.",
    ...
    zpUsePermanentWeaponsDesc: "Unlock powerful weapons permanently.",
    zpUseSkinsDesc: "Exclusive appearance customization.",
    zpUseVVIPDesc: "Permanent weapons with special effects.",
    zpUseCrateKeysDesc: "Unlock mystery crates for rare items.",
    zpUseBoostsDesc: "Earn GP faster, unlock free rewards.",
  ...
  ar: {
    ...
    onThisWikiDesc: "ويكي CrossFire مرجع مجتمعي يغطي كل جوانب لعبة CrossFire. استكشف الأسلحة والخرائط والرتب والشخصيات والمزيد.",
    didYouKnow: "هل تعلم؟",
    quickNavigation: "تنقل سريع",
    communityLabel: "المجتمع",
    joinOurDiscord: "انضم إلى ديسكورد",
    activePlayersCount: "مئات من لاعبي CF النشطين",
    joinNow: "انضم الآن",
    ...
    portalMercenariesDesc: "عمليون نخبة",
    ...
    pricingSubheading: "كل اللي تحتاجه — الأسعار، وين تصرف، ومن وين تشحن بأمان.",
    ...
    pricingBonus: "بونص",
    pricingSafeTip1: "اشتري فقط من متجر Z8Games الرسمي أو البائعين الموثوقين في المجتمع.",
    ...
    pricingSafeTip4: "إذا بدت الصفقة جيدة جداً لتكون حقيقية، فهي كذلك — التزم بالمصادر الموثوقة.",
    pricingSafeTip5: "تحقق من صفحة البائعين الموثوقين لمزودي خدمة موثقين.",
    ...
    zpUsePermanentWeaponsDesc: "افتح أسلحة قوية بشكل دائم.",
    zpUseSkinsDesc: "تخصيص مظهر حصري.",
    zpUseVVIPDesc: "أسلحة دائمة بمؤثرات خاصة.",
    zpUseCrateKeysDesc: "افتح صناديق الغموض للحصول على عناصر نادرة.",
    zpUseBoostsDesc: "اكسب GP أسرع وافتح مكافآت مجانية.",
