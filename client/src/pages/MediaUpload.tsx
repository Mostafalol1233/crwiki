    ...
    <div className="container mx-auto max-w-4xl py-6 px-4">
      <Card>
        <CardHeader>
          ...
          <Tabs value={uploadMethod} onValueChange={(v) => setUploadMethod(v as "server" | "catbox")} className="w-full mt-4">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="server" className="flex items-center gap-2">
                <Server className="h-4 w-4" />
                Server (MongoDB)
              </TabsTrigger>
              <TabsTrigger value="catbox" className="flex items-center gap-2">
              ...
              {uploadMethod === "catbox" && (
                <div className="bg-muted p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Catbox is an external file hosting service. Files uploaded here are public and not stored on our server. 
                    Use this for temporary sharing or when server storage is limited.
                  </p>
                </div>
              )}
