...
const SECTIONS: HardcodedSection[] = [
  ...
  },
  {
    ...
    color: '#d4a017',
    entries: [
      { label: 'Copyright (EN)', value: '© 2026 CrossFire Wiki — All Rights Reserved', file: 'LanguageProvider.tsx line 43', description: 'Also appears on Privacy and Terms pages (2026 variant).' },
      { label: 'Copyright (AR)', value: '© 2026 CrossFire Wiki — جميع الحقوق محفوظة', file: 'LanguageProvider.tsx line 509' },
      { label: 'Privacy / Terms copyright', value: '© 2026 CrossFire Wiki. All rights reserved.', file: 'LanguageProvider.tsx lines 416, 455' },
      { label: 'About page title', value: 'CrossFire Game Overview — Wiki | CrossFire Wiki', file: 'About.tsx line 148' },
