...
export class MemoryStorage {
    ...
    constructor() {
        ...
        for (const ev of seedEvents) {
            this.events.unshift({ id: crypto.randomUUID(), createdAt: new Date(), ...ev });
        }
    }
    // Users
    async getUser(id) {
    ...
    async createUser(user) {
        const u = { ...user, id: crypto.randomUUID(), createdAt: new Date(), verifiedEmail: false, verifiedPhone: false };
        this.users.push(u);
        return u;
    }
    ...
    async createPost(post) {
        const p = { ...post, id: crypto.randomUUID(), createdAt: new Date(), views: 0 };
    ...
    async createComment(comment) {
        const c = { ...comment, id: crypto.randomUUID(), createdAt: new Date(), likes: 0, likedBy: [] };
    ...
    async createEvent(event) {
        const e = { ...event, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createNews(news) {
        const n = { ...news, id: crypto.randomUUID(), createdAt: new Date() };
        this.news.unshift(n);
        return n;
    }
    ...
    async createTicket(ticket) {
        const t = { ...ticket, id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() };
    ...
    async createTicketReply(reply) {
        const r = { ...reply, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createAdmin(admin) {
        const a = { ...admin, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createNewsletterSubscriber(subscriber) {
        const s = { ...subscriber, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createSeller(seller) {
        const s = { ...seller, id: crypto.randomUUID(), createdAt: new Date(), images: seller.images || [], prices: seller.prices || [], averageRating: 0, totalReviews: 0 };
    ...
    async createSellerReview(review) {
        const r = { ...review, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createConversation(conv) {
        const c = { id: crypto.randomUUID(), participants: conv.participants, createdAt: new Date(), lastMessageAt: undefined };
    ...
    async createMessage(msg) {
        const m = { id: crypto.randomUUID(), conversationId: msg.conversationId, senderId: msg.senderId, content: msg.content, mentions: msg.mentions || [], replyTo: msg.replyTo, readBy: [], status: 'sent', createdAt: new Date() };
    ...
    async createTutorial(tutorial) {
        ...
        const t = { ...tutorial, id: crypto.randomUUID(), createdAt: new Date(), likes: 0, tutorial_slug: slug };
    ...
    async createTutorialComment(comment) {
        const c = { ...comment, id: crypto.randomUUID(), createdAt: new Date() };
    ...
    async createWeapon(weapon) {
        const w = { ...weapon, id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() };
    ...
    async createMode(mode) {
        const m = { ...mode, id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() };
    ...
    async createMap(map) {
        const m = { ...map, id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() };
        this.maps.unshift(m);
        return m;
    }
    async updateMap(id, map) {
        ...
        if (idx === -1)
            return undefined;
        this.maps[idx] = { ...this.maps[idx], ...map, updatedAt: new Date() };
    ...
    async createRank(rank) {
        const r = { ...rank, id: crypto.randomUUID(), createdAt: new Date(), updatedAt: new Date() };
